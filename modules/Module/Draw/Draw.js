...
//				this.deactivateButtonsAndControls( button );
	...
	styleFeature : function(feature){
		...
		if (tempstyle.fillColor!=defaultstyle.fillColor||tempstyle.externalGraphic){
...
//			return false;
	...
	drawTheFeatures : function(drawParam){
			...
			if (startfeatures && startfeatures.length>=1) {
				...
				var strend = str.substring(str.length-2,str.length);  // If the string ends with a newline character this must be romoved. /K-M
